...
const description =
  'This is my personal dashboard, built with Next.js API routes deployed as serverless functions. I use this dashboard to track various metrics across platforms like YouTube, GitHub, Strava, and more.'
  ...
  return (
    <>
      <PageTitle
        ...
        across platforms like YouTube, GitHub, Strava, and more.'
      />
      <Items />
    </>
  )
