    ...
    <div className='mt-12 flex justify-center'>
      <button
        ...
        className={cn([
          ...
          'before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-br bg-gray-700 before:from-[#ca2828] before:content-[""]'
        ])}
        type='button'
        onClick={handleLike}
      ...
      >
        <motion.span
          className='absolute inset-0 rounded-lg bg-gradient-to-br from-[#8d2c1f] to-[#2d3686] blur-xl'
