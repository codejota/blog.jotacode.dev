...
const BlogPage = () => {
  ...
  return (
    <>
      <PageTitle
        title='Blog'
        description={`I started writing articles in May 2019, mainly about software and
